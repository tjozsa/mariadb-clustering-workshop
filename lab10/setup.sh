...
docker exec -it lab4_slave2_1 mysql -pslave2secret -e "stop slave;" -e "CHANGE MASTER TO MASTER_HOST = 'master', MASTER_USER = 'repl', MASTER_PASSWORD = 'slavepass' ,MASTER_LOG_FILE = 'mariadb-bin.000003', MASTER_LOG_POS = 662 MASTER_DELAY = 120;" -e "start slave;" -e "SHOW SLAVE STATUS \G;"
